-- MySQL dump 10.11
--
-- Host: localhost    Database: tvupdate_en
-- ------------------------------------------------------
...
INSERT INTO `product_category` VALUES (1,'2014-03-31 16:00:00','All',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=30471 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `system_client_2`
--
...
CREATE TABLE `system_client_2` (
  ...
  `username` varchar(17) collate utf8_bin NOT NULL,
  `product_model` varchar(40) collate utf8_bin default '',
  `gujian_version` varchar(20) collate utf8_bin default '',
  `gujian_version_after` varchar(20) collate utf8_bin default '1.0',
  `successful` varchar(1) collate utf8_bin default '0',
  PRIMARY KEY  (`id`)
...
--
-- Dumping data for table `system_client_2`
--

LOCK TABLES `system_client_2` WRITE;
/*!40000 ALTER TABLE `system_client_2` DISABLE KEYS */;
/*!40000 ALTER TABLE `system_client_2` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `system_user` VALUES (1,'2014-03-31 16:00:00','系统管理员','','chupdate_admin','wlgs8888',1);
...
-- Dump completed on 2015-11-02 10:55:52
