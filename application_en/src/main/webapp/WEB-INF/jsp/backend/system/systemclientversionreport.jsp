                ...
                <div class="search">
                    ...
                    <span>
                        ...
                        <select id="reportType" style="width: 100px;">
                            <option value="1" <c:if test="${reportType=='1'}">selected="true"</c:if>>Line Graph</option>
                            <option value="0" <c:if test="${reportType=='0'}">selected="true"</c:if>>Pie Chart</option>
                        </select>
                        &nbsp;
                    </span>
...
<script type="text/javascript">
    ...
    function renew_sta_container(productModel, reportType) {
        if(productModel == '') {
            return;
        }
        ...
        if("1" == reportType) {
            ...
            jQuery("#container4_tr").hide();
                ...
                SystemDWRHandler.obtainClientVersionAmountByResult(productModel, function(result) {
    ...
    function generateReport() {
        ...
        renew_sta_container(productModel, reportType);
    }
