    ...
    <tr>
        ...
        <td valign="top">
            <div style="float: left; padding-right: 5px; padding-top: 5px; padding-left: 5px;">
                <a href="#" onclick="window.location.href = '${pageContext.request.contextPath}/backend/userform.html'"><button class="thoughtbot">New User</button></a>
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list">
                ...
                <c:forEach items="${users}" var="user">
                    ...
                    <c:set var="turns" value="${!turns}"/>
                        ...
                        <td>
                            <a href="#"onclick="window.location.href='${pageContext.request.contextPath}/backend/userform.html?userId=${user.id}&filername=${filername}&current=${current}'"><button class="thoughtbot">Edit</button></a>
