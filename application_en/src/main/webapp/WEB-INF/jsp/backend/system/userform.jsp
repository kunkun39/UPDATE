        ...
        <td valign="top">
            <spring-form:form commandName="user" method="POST" cssClass="form">
                <table cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>
                             Worker Code(username) <span class="required">*</span>
                        </td>
                        <td>
...
<script type="text/javascript">
    ...
    function loadCategories(){
        jQuery("#dailog").dialog({
            ...
            width: "400",
            height: "200",
            title: "Please select product category this user will response."
        });
        ...
        jQuery("#categoryDailog").jstree({
            ...
            if(addIds.indexOf(categoryId + "|") < 0) {
                ...
                var addHtml = "<div id=\"manage_category_" + categoryId + "\">" + catgorypath + "<a onclick=\"removeManageCategory('" + categoryId + "')\" href=\"#\"><input type=\"button\" value=\"Delete\"/></a></div>"
