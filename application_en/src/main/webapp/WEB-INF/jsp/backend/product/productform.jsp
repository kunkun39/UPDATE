    ...
    <script type="text/javascript">
        function loadCategories(){
        	jQuery("#dailog").dialog({
                ...
                width: "400",
                height: "200",
                title: "Please select category for this product"
    		});
        ...
        <td valign="top">
            <spring-form:form commandName="product" method="POST" cssClass="form">
                <table cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td width="200px;">
                             Model(<font color="red">content should not contains the follow symbol:"<",">","=","?",":","blank"</font>) <span class="required">*</span>
                        </td>
                    ...
                    <tr>
                        <td>
                            Belong to <span class="required">*</span>
                        </td>
                        <td>
