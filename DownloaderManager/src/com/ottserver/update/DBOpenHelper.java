...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	private final static String DBNAME = "loader.db";//数据库名称
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql = "CREATE TABLE IF NOT EXISTS "
								+ "downloadlog(id integer primary key autoincrement,downpath varchar(100),view varchar(10),path varchar(100),"
