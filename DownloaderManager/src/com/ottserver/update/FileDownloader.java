...
/***
 *  @author   TangChao
 *  <Type Create time>     2014年4月15日  、    上午1:10:59
 *  TODO  >>  文件下载器
 *****************************************************************************************
 */
...
//		this.data.put(threadId, downPosition);
	...
	public int downLoad(DownloadProgressListener downloadProgressListener )throws Exception{
			try {
				...
				fileService.save(this.downLoadUrl,Constant.view,Constant.path, this.data);//把已经下载的写进数据库
...
//								fileService.deleteAll();
				...
				throw new RuntimeException("空间不够！！！");
			}
